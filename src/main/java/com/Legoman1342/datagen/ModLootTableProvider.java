...
import com.Legoman1342.datagen.loot.ModBlockLootTables;
...
public class ModLootTableProvider extends LootTableProvider {
	...
	private final List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet>> loot_tables
			...
			Pair.of(ModBlockLootTables::new, LootContextParamSet.CHEST),
			Pair.of(ModBlockLootTables::new, LootContextParamSet.ENTITY)*/
	);
